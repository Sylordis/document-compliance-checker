...
class VersionDocReportPrinter(ReportPrintingStrategy):
  """Printer for VersionDoc compliance reports"""
  ...
  def output(self, compliance_strategy : ComplianceStrategy, reports : list[DocumentComplianceReport], target : str):
    with open(target, 'w', newline='') as csvfile:
      ...
      for report in reports:
        ...
        row=[document.reference, document.title, document.version]
